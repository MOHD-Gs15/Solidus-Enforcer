...
Current family: **2.1.x** — Core (2.2.4 network family, reflection bridge tolerates 2.1.x), Analytics (2.1.4), Governance (2.1.1), and Enforcer (2.1.1) are aligned on it.
